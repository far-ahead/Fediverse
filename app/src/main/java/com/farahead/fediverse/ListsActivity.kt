...
import com.farahead.fediverse.fragment.TimelineFragment
import com.farahead.fediverse.util.*
import com.farahead.fediverse.viewmodel.ListsViewModel
import com.farahead.fediverse.viewmodel.ListsViewModel.Event.*
import com.farahead.fediverse.viewmodel.ListsViewModel.LoadingState.*
        ...
        when (state.loadingState) {
            ...
            LOADED ->
                if (state.lists.isEmpty()) {
                    messageView.show()
                    messageView.setup(R.drawable.splash, R.string.message_empty,
                            null)
                } else {
                    messageView.hide()
                }
