...
package com.farahead.fediverse.components.report.fragments
...
import com.farahead.fediverse.AccountActivity
import com.farahead.fediverse.R
import com.farahead.fediverse.ViewMediaActivity
import com.farahead.fediverse.ViewTagActivity
import com.farahead.fediverse.components.report.ReportViewModel
import com.farahead.fediverse.components.report.Screen
import com.farahead.fediverse.components.report.adapter.AdapterHandler
import com.farahead.fediverse.components.report.adapter.StatusesAdapter
...
import com.farahead.fediverse.util.hide
import com.farahead.fediverse.util.show
import com.farahead.fediverse.viewdata.AttachmentViewData
...
class ReportStatusesFragment : Fragment(), Injectable, AdapterHandler {
    ...
    private fun initStatusesView() {
        ...
        viewModel.networkStateAfter.observe(viewLifecycleOwner, Observer {
            if (it?.status == com.farahead.fediverse.util.Status.RUNNING)
                progressBarBottom.show()
            else
                progressBarBottom.hide()

            if (it?.status == com.farahead.fediverse.util.Status.FAILED)
                showError(it.msg)
        })
        ...
        viewModel.networkStateRefresh.observe(viewLifecycleOwner, Observer {
            if (it?.status == com.farahead.fediverse.util.Status.RUNNING && !swipeRefreshLayout.isRefreshing)
